        ...
        <dl>
            <form action="regist.do" method="get" >
                ...
                <dd>
                    ...
                    <input name="password" type="password" class="inputh lf" value="" />
                    <div class="lf red laba">密码要求不低于6个字符</div>
                </dd>
                <dd>
                    <label> <small>*</small>身份证号</label>
                    <input name="idCard" type="text" class="inputh lf" value="" />
                    <div class="lf red laba">身份证号必填</div>
                </dd>
                <dd>
                    <label> <small>*</small>电话</label>
                    <input name="phone" type="text" class="inputh lf" value="" />
                    <div class="lf red laba">电话号码必填</div>
                </dd>
                <dd>
                    <label> <small>*</small>住址</label>
                    <input name="address" type="text" class="inputh lf" value="" />
                </dd>
                <dd>
                    <label> <small>*</small>邮政编码</label>
                    <input name="postCode" type="text" class="inputh lf" value="" />
                </dd>
                <dd class="hegas">
