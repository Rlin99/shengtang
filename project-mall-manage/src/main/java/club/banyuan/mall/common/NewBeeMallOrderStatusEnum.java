...
public enum NewBeeMallOrderStatusEnum {
    ...
    public static club.banyuan.mall.common.NewBeeMallOrderStatusEnum getNewBeeMallOrderStatusEnumByStatus(int orderStatus) {
        for (club.banyuan.mall.common.NewBeeMallOrderStatusEnum newBeeMallOrderStatusEnum : club.banyuan.mall.common.NewBeeMallOrderStatusEnum.values()) {
