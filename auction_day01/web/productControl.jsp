...
<div class="wrap">
    ...
    <form action="search.do">
        <div class="forms">
            ...
            <a href="addProduct.jsp"><input type="button"  value="发布" class="spbg buttombg f14  sale-buttom buttomb"/></a>
        </div>
    </form>
    ...
    <div class="items">
        ...
        <ul class="rows">
            ...
            <li class="borderno red">
                <a href="alter.do?id=<%=product.getId()%>" title="竞拍" onclick="dele();">修改</a>|
                <a href="delete.do?id=<%=product.getId()%>" title="竞拍" onclick="abc();">删除</a>
            </li>
        </ul>
        <%
            }
