        ...
        <div class="sidebarg fnone">
            <form action="adminLogin.do" method="post" target='_blank'>
                <div class="login">
                        <dl>
                            <dt>管理员登陆</dt>
                            <dd><label for="name">用户名：</label><input name="userName" type="text" class="inputh"  id="name"/></dd>
                            <dd><label for="password">密 码：</label><input name="password" type="text" class="inputh"  id="password"/></dd>
                            <dd>
                                <label class="lf" for="passwords">验证码：</label>
                                <input type="text" class="inputh inputs lf" value="" id="passwords"/>
